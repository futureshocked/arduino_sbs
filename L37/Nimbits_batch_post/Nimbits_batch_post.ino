...
char mailaddr [] = "peter@arduinosbs.com";    // your email address for the logging account
char key [] = "asfdgd084inudfiun";                     // your KEY you created for the account. Not the UUID.
...
void sendData() {
    ...
    cont.print("&p1=Test&v1=");        // test123 is the name of a data point you created
    cont.print(ana_A,DEC);                // latest analog value. Replace this with whatever you are logging
    cont.print("&p2=Test2&v2=");        // test456 is another data point you created
